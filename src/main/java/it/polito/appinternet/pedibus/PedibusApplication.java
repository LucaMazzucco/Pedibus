...
public class PedibusApplication {
    ...
    public void init() {
        ...
        Child c1 = new Child("Ginevra", "Rossi", "RSSGNV04R20E290Z", "","Linea Azzurra", "Corso Peschiera, 251");
        Child c2 = new Child("Francesco", "Neri", "NRIFRN05R20E291Z", "", "Linea Viola", "Corso Duca degli Abruzzi");
        Child c3 = new Child("Michele", "Verdi", "VRDMCH07R20E290Z", "", "Linea Azzurra", "Corso Duca degli Abruzzi");
